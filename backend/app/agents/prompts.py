...
- risk_level must be exactly one of: Low, Medium, High, Critical — a single word, never combined or separated by "|".- risk_level must be exactly one of: Low, Medium, High, Critical — a single word, never combined or separated by "|".
